...
> Status: **scaffold (M0)**. The architecture, security model and roadmap are complete; the
> backend is a working secure skeleton with a demo data source; the frontend is a placeholder
> scene proving the end-to-end data path. See [`docs/HANDOVER.md`](docs/HANDOVER.md) for exactly
...
| `scripts/` | `publish.sh` (create the public repo) and `harden-repo.sh` (GitHub security settings) |
